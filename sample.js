...
user.findOne({regno: req.body.regno} , function(err , user1) {
    if(err)
    {
        console.log(err);
    } else {
        ...
        if(user1 == undefined )
        {
            ...
            console.log('no such user');
                user.create({regno: req.body.regno , name: req.body.name  , dept: 'test' } , 
    function(err , user) {
        if(err)
        {
            console.log(err);
...
regno: req.body.regno , name: req.body.name , dept: req.body.dept